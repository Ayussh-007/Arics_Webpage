...
const PriceSummary = ({ pricing, deliveryDays }) => {
  return (
    <GlassCard className="p-6 space-y-4">
      <h3 className="text-xl font-['Playfair_Display']">Price Summary</h3>
      <div className="space-y-2 text-sm text-slate-700">
        ...
        <div className="flex justify-between font-semibold text-slate-900 pt-2 border-t border-white/50">
          <span>Total</span>
